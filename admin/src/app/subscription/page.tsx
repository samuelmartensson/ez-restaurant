...
const Subscription = () => {
  ...
  const isActive =
    !customer?.cancelInfo?.isExpired && customer?.subscription === 1;
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center">
                  ...
                  <span className="font-medium">SEK 499</span>
                </div>
              </div>
            </div>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-blue-700 dark:text-blue-400">
                    <p>
                      Subscription will automatically renew 1 month from
                      activation. You can cancel anytime before the renewal
                      date.
                    </p>
                  </div>
                </div>
